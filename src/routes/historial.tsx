...
const LACADO_COLS: ColSpec[] = [
  ...
  { group: "ALUMINIO DISUELTO DESENGRASE 1", header: "Aluminio disuelto desengrase 1 (g/L)", get: (r) => r.resultados["Aluminio disuelto desengrase 1"] ?? null, max: 2, numFmt: "0.000", width: 18 },
  { group: "ALUMINIO DISUELTO DESENGRASE 2", header: "Aluminio disuelto desengrase 2 (g/L)", get: (r) => r.resultados["Aluminio disuelto desengrase 2"] ?? null, max: 2, numFmt: "0.000", width: 18 },
];
